...
<head>
    <meta charset="utf-8">
    <title>Merchant Login - Orangeskygroup</title>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="./" class="nav-item nav-link">Merchant</a>
                                <a href="../?menu=contact" class="nav-item nav-link">Contact</a>
                                 
                            </div>
                            <?php if (!empty($_SESSION['osg_merchant_id'])) { ?>
                                <a href="../?menu=merchant" class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block"><i class="fa fa-user ms-3"></i> Merchant Account</a>
                            <?php } else { ?>
                                <a href="../merchant/" class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block"><i class="fa fa-user ms-3"></i> Login/ Sign Up</a>
                            <?php } ?>
                        </div>
                    </nav>
                </div>
