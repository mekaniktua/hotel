                        ...
                        <form id="frmSave" name="frmSave" enctype="multipart/form-data">
                            <div class="row form-group">
                                <div class="col-md-4 form-group text-center">
                                    <img src="<?php echo (!empty($rData['property_url']) ? "../".$rData['property_url'] : "images/no_image.png"); ?>"
                                        width="50%" class="img-thumbnail form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="hidden" name="pID"
                                                value="<?php echo enkripsi($property_id); ?>">
                                            <input type="hidden" name="jenisInput"
                                                value="<?php echo enkripsi('Edit'); ?>">
                                            <input type="text" name="property_name"
                                                value="<?php echo $rData['property_name'] ?>" class="form-control"
                                                required>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>NO TELP</label>
                                            <input type="text" name="telp" id="telp"
                                                value="<?php echo ($rData['telp']); ?>" class="form-control" required>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>EMAIL</label>
                                            <input type="email" name="email" id="email"
                                                value="<?php echo ($rData['email']); ?>" class="form-control">
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>CITY</label>
                                            <input type="text" name="city" id="city"
                                                value="<?php echo ($rData['city']); ?>" class="form-control" required>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <label>ADDRESS</label>
                                            <input type="text" name="address" id="address"
                                                value="<?php echo ($rData['address']); ?>" class="form-control"
                                                required>
                                        </div>
                                    </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 form-group text-center">
                                    ...
                                    <button type="button" class="btn btn-danger" onclick="back()"><i
