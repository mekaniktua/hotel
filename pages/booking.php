    ...
    <div class="container-fluid">
        ...
        <div class="row g-4">
            <div class="col-lg-8 col-md-12 wow fadeInUp" style="color: black;font-size: 18px;" data-wow-delay="0.2s">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4 mt-1">
                            <div class="col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                                <textarea id="special_request" class="form-control" rows="5" placeholder="Type your request here"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3" style="box-shadow: 0 0 45px rgba(0, 0, 0, .08);">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h5 class="mb-0 fs-5"><i class="fas fa-solid fa-coins"></i> Points<span style="color: red;">*</span></h5>
                        ...
                        <div class="row g-4 mt-1">
                            <div class="col-md-12 wow fadeInUp d-flex align-items-center" data-wow-delay="0.1s">
                                ...
                                <input type="text" class="form-control me-2" value="<?php echo $max_point_used; ?>" name="point_used" id="point_used" placeholder="Enter points" style="max-width: 200px;">

                                <button class="btn btn-primary" id="btnPoint">Use Point</button><br />
                            </div>
                            <small class="text-muted fs-6" style="margin-top: 0">Enter 0 if you don't want to use any points.</small>
                        </div>
                    </div>
                </div>
                <div class="card mb-3" style="box-shadow: 0 0 45px rgba(0, 0, 0, .08);">
                    <div class="card-body">
                        ...
                        <form id="frmSimpan" method="post" action="">
                            <input type="hidden" name="bID" id="bID" value="<?php echo enkripsi($rData['booking_id']); ?>">
                            <div class="row g-4 mt-1">
                                <div class="col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                                    ...
                                    <button class="btn btn-primary btn-lg mt-3" style="width: 100%;" id="btnConfirm">Confirm Booking</button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card mb-3" style="box-shadow: 0 0 45px rgba(0, 0, 0, .08);">
                    <div class="card-body">
                        <h5 class="mb-0 fs-5"><i class="fas fa-solid fa-user me-2"></i>Login</h5>
                        ...
                        <form id="frmLogin" method="post">
                            <div class="row g-4 mt-1">
                                ...
                                <div class="col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                                    <button class="btn btn-primary btn-lg mt-3" style="width: 100%;" id="btnLogin">Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card mb-3" style="box-shadow: 0 0 45px rgba(0, 0, 0, .08);">
                    <div class="card-body">
                        <div class="d-flex mb-5">
                            <div class="me-3" style="width: 250px; height: 150px; overflow: hidden; border-radius: 0.375rem;">
                                <img src="<?php echo $rData['property_url'] ?>" style="object-fit: cover; width: 100%; height: 100%;" class="rounded img-fluid" alt="<?php echo $rData['property_name'] ?>">
                            </div>
                            <div>
                                <h5 class="mb-2 "><?php echo $rData['property_name'] ?></h5>
                                <small class="text-muted  "><?php echo $rData['address'] ?></small><br>
                                <i class="fa fa-map-marker text-primary me-2"></i><small class="text-muted"><?php echo $rData['city'] ?></small>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="align-self-start">
                                ...
                                <p class="mb-3">
                                    ...
                                    <span class="text-secondary"><i class="fas fa-bed me-1"></i><?php echo $rRoom['bed']; ?> Bed</span> |
                                    <span class="text-secondary"><i class="fa fa-solid fa-user"></i><?php echo $rData['adult']; ?> <i class="fa fa-solid fa-child"></i><?php echo $rData['child']; ?></span>
                                </p>

                                <ul class="p-0 list-unstyled">
                                    <?php while ($rFacility = mysqli_fetch_array($qFacility)) { ?>
                                        <li class="text-muted"><i class="fa fa-check text-success me-2"></i><?php echo $rFacility['facility_name'] ?></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
