                        ...
                        <tbody>
                           <?php while ($rData = mysqli_fetch_array($qData)) {
                              ...
                              <tr>
                                 <td>
                                    <div class="dropdown">
                                       <button class="btn btn-success dropdown-toggle" type="button" id="menuProperti" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                          <i class="fa fa-pencil"></i>
                                       </button>
                                       <div class="dropdown-menu" aria-labelledby="menuProperti">
                                          <a class="dropdown-item" onclick="edit('<?php echo enkripsi($rData['property_id']); ?>')" href="#">Property Edit</a>
                                          <a class="dropdown-item" onclick="roomType('<?php echo enkripsi($rData['property_id']); ?>')" href="#">Room Type</a>
                                          <a class="dropdown-item" href="#" onclick="hapus('<?php echo enkripsi($rData['property_id']); ?>')">Delete Property</a>
                                       </div>
                                    </div>
                                 </td>
                                 <td style="width: 100px;"><img src="<?php echo (!empty($rData['property_url']) ? "../".$rData['property_url'] : "images/no_image.png"); ?>" height="50px"></td>
