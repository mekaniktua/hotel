                  ...
                  <form id="frmSave" name="frmSave" enctype="multipart/form-data">
                     <div class="row form-group">
                        <div class="col-md-12 form-group text-center">
                           <img src="images/no_image.png" width="25%" class="img-thumbnail form-group">
                           <br />
                        ...
                        <div class="col-md-12 form-group">
                           <div class="row form-group">
                              ...
                              <div class="col-md-4 form-group">
                                 ...
                                 <input type="email" id="start_date" name="start_date" class="form-control datepicker" required>
                              </div>
                              <div class="col-md-4 form-group">
                              ...
                              <div class="col-md-12 form-group">
                                 ...
                                 <textarea id="description" name="description" class="form_control"></textarea>
                              </div>
                           </div>
