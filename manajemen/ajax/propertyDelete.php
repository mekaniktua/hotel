...
$property_id = amankan(dekripsi($_POST['prID']));


//Cari di tabel property apakah sudah ada?
$sCari  = " SELECT *
            FROM property
            WHERE property_id='" . $property_id . "' and status_hapus='0'";
...
if ($nCari < 1) { // Jika tidak ketemu keluar notif
  $pesan = "<i class='fa fa-times'></i> Data not found";
}
if (empty($pesan)) {
